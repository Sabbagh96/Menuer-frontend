...
module.exports = {
  ...
  theme: {
    extend: {colors: {
      ...
      'menuer-logo-menuer-logo-dark': 'linear-gradient(to bottom, rgba(46,45,45,0.179) 0%,rgba(46,45,45,0.180) 100%)',
      'menuer-logo-menuer-logo-light': 'linear-gradient(to bottom, rgba(255,255,255,1) 0%,rgba(255,255,255,1) 100%)',
      'menuer-logo-menuer-logo-primary': 'linear-gradient(to bottom, rgba(237,41,139,0.931) 0%,rgba(238,51,144,0.933) 100%)',
    },
    boxShadow: {
      ...
      'drop-shadow-default': '0px 1px 2px rgba(0,0,0,0.100), 0px 1px 1px rgba(0,0,0,0.060)',
      'drop-shadow-md': '0px4px 3px rgba(0,0,0,0.070), 0px 2px 2px rgba(0,0,0,0.060)',
      'drop-shadow-lg': '0px 10px 8px rgba(0,0,0,0.040), 0px 4px 3px rgba(0,0,0,0.100)',
      'drop-shadow-xl': '0px 20px 13px rgba(0,0,0,0.030), 0px 8px 5px rgba(0,0,0,0.080)',
