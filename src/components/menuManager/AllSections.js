...
import SectionItemsById from "../createBusiness/SectionItemsById";
...
const AllSections = () => {
  ...
  return (
    <div>
      <div className="w-[800px] mt-[56.5px] mb-[20px] flex justify-between mx-auto px-4 ">
        <div className=" text-zinc-800  text-lg font-medium font-['Alexandria'] leading-[27px]">
          Menu Manager
        </div>
        <Link
          to={"/menumanageradditem"}
          className="w-[150px] h-18 border shadow-2xl rounded-[20px] border-slate-500 border-opacity-20 justify-center items-center gap-2 text-pink-400 text-sm font-medium font-['Alexandria'] leading-[21px]"
        >
          Add Item
        </Link>
      </div>
      <div className="flex justify-between p-6 w-[800px] mx-auto bg-gray-50 mt-4 shadow-2xl border rounded-3xl">
        <div className="">
          {addSection && (
          ...
          <div className="grid grid-cols-4 -mt- gap-10">
            <button
